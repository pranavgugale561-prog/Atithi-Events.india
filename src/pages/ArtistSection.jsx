...
import { Star, Mic2, Loader, X, ChevronLeft, ChevronRight, Play, Share2 } from 'lucide-react';
import { getArtists } from '../utils/services';
...
export default function ArtistSection() {
  ...
  artists.forEach(art => {
    ...
    categoriesMap.get(cat).push(art);
  });
    ...
    <div style={{ backgroundColor: 'var(--bg-primary)', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <div style={{ 
        ...
        <div style={{
          position: 'absolute',
          inset: 0,
          backgroundImage: 'url(https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?q=80&w=2000&auto=format&fit=crop)',
        ...
        <div className="animate-in" style={{ position: 'relative', zIndex: 2, textAlign: 'center', maxWidth: '900px' }}>
          ...
          >
            <Mic2 size={16} color="var(--accent-gold)" />
          ...
          >
            Artists & <span style={{ fontStyle: 'italic', color: 'var(--accent-gold)' }}>Entertainment</span>
          </motion.h1>
          ...
          >
            Elevate your celebration with our extensive roster of live performers, interactive game stalls, and unique amusement setups.
          </motion.p>
        </div>
      </div>
        ...
        {loading ? (
          ...
          <div style={{ maxWidth: 1400, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '6rem', padding: '5rem 24px' }}>
            {groupedData.length === 0 ? (
              <p style={{ textAlign: 'center', color: 'rgba(255,255,255,0.5)', padding: '40px' }}>Loading or no artists available.</p>
                    ...
                    >
                      {item.images && item.images.length > 0 ? (
                        ...
                        <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                          <Star size={64} color="var(--accent-gold)" style={{ opacity: 0.2 }} />
                        </div>
                      )}
